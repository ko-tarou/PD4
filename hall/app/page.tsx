...
export default function OrderBoard() {
  const [done, setDone] = useState<Item[]>([
    ...
    { id: 2, label: '〇（卓番）：〇（個数）はし', color: 'gray' },
    { id: 3, label: '〇（卓番）：〇（個数）取り皿', color: 'gray' },
    { id: 4, label: '〇（卓番）：〇（個数）水', color: 'blue' },
    { id: 5, label: '〇（卓番）：皿', color: 'gray' },
    { id: 6, label: '〇（卓番）：醤油', color: 'gray' },
  ]);
